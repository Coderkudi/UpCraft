    ...
    useEffect(() => {
        const fetchCourseData = async () => {
            try {
                ...
                setCourseTitle(response.data.courseTitle || "Course");
            } catch (error) {
        ...
        // Load local storage for THIS course
        const stored = JSON.parse(localStorage.getItem(`completed_${courseId}`) || '[]');
        setCompletedLessonIds(stored);
    }, [courseId, navigate]);

    const allLessonsCompleted = lessons.length > 0 && lessons.every(l => completedLessonIds.includes(l._id));
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid gap-4 mb-12">
                    {lessons.map((lesson, index) => {
                        ...
                        // Unlock logic: First lesson always open. Others require previous to be done.
